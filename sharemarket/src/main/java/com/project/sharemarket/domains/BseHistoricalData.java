...
public class BseHistoricalData implements java.io.Serializable {
	...
	public BseHistoricalData(String scCode, String scName, String scGroup, String scType, BigDecimal open,
			BigDecimal low, BigDecimal close, BigDecimal last, BigDecimal prevclose, int noTrades, int noOfShrs,
			BigDecimal netTurnov, String isinCode, Date tradingDate) {
		this.scCode = scCode;
		this.scName = scName;
	...
	public BseHistoricalData(String scCode, String scName, String scGroup, String scType, BigDecimal open,
			BigDecimal high, BigDecimal low, BigDecimal close, BigDecimal last, BigDecimal prevclose, int noTrades,
			int noOfShrs, BigDecimal netTurnov, String tdcloindi, String isinCode, Date tradingDate, String filer1,
			String filer2) {
		this.scCode = scCode;
		this.scName = scName;
		this.scGroup = scGroup;
